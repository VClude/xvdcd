...
<div class="form-group">
    {!! CollectiveForm::label('alternate', 'Alternate' . trans('ticketit::admin.colon'), ['class' => '']) !!}
    {!! CollectiveForm::text('alternate', isset($category->alternate) ? $category->alternate : null, ['class' => 'form-control']) !!}
</div>
<div class="form-group">
