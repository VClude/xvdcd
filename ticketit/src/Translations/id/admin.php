...
return [
  ...
  */
  ...
  'table-remove-agent'            => 'Remove from Surveyors',
...
// tickets-admin/____
  'index-title'                         => 'Complains System Dashboard',
  'index-empty-records'                 => 'No Complains yet',
  'index-total-tickets'                 => 'Total Complains',
  'index-open-tickets'                  => 'Open Complains',
  'index-closed-tickets'                => 'Closed Complains',
  ...
  'index-tickets-share-per-category'    => 'Complains share per category',
  'index-tickets-share-per-agent'       => 'Complains share per Surveyor',
  'index-categories'                    => 'Categories',
  'index-category'                      => 'Category',
  'index-agents'                        => 'Surveyors',
  'index-agent'                         => 'Surveyor',
  'index-administrators'                => 'Administrators',  //new
  'index-administrator'                 => 'Administrator',  //new
  'index-users'                         => 'Users',
  'index-user'                          => 'User',
  'index-tickets'                       => 'Complains',
  'index-open'                          => 'Open',
  'index-closed'                        => 'Closed',
  'index-total'                         => 'Total',
  'index-month'                         => 'Month',
  'index-performance-chart'             => 'How many days in average to resolve a Complain?',
  'index-categories-chart'              => 'Complains distribution per category',
  'index-agents-chart'                  => 'Complains distribution per Surveyor',

// tickets-admin/agent/____
  'agent-index-title'             => 'Surveyor Management',
  'btn-create-new-agent'          => 'Create new Surveyor',
  'agent-index-no-agents'         => 'There are no Surveyors, ',
  'agent-index-create-new'        => 'Add Surveyors',
  'agent-create-title'            => 'Add Surveyor',
  'agent-create-add-agents'       => 'Add Surveyors',
  'agent-create-no-users'         => 'There are no user accounts, create user accounts first.',
  'agent-create-select-user'      => 'Select user accounts to be added as Surveyors',
...
// tickets-admin/configuration/____
  ...
  'config-index-tickets'          => 'Complains',
